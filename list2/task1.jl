...
modified_x64 = [2.718281828,-3.141592654,1.414213562,0.577215664,0.301029995]
modified_x32 = map(a -> convert(Float32, a), modified_x64)
...
println("Wynik dla zmodyfikowanego 'w przod' i Float64: ", forward(modified_x64, y64, 5))
println("Wynik dla zmodyfikowanego 'w przod' i Float32: ", forward(modified_x32, y32, 5))

println("Wynik dla zmodyfikowanego 'w tyl' i Float64: ", backward(modified_x64, y64, 5))
println("Wynik dla zmodyfikowanego 'w tyl' i Float32: ", backward(modified_x32, y32, 5))

println("Wynik dla zmodyfikowanego najwiekszy-najmniejszy i Float64: ", fromTheBiggestToTheSmallest(modified_x64, y64, Float64, 5))
println("Wynik dla zmodyfikowanego najwiekszy-najmniejszy i Float32: ", fromTheBiggestToTheSmallest(modified_x32, y32, Float32, 5))

println("Wynik dla zmodyfikowanego najmniejszy-najwiekszy i Float64: ", fromTheSmallestToTheBiggest(modified_x64, y64, Float64, 5))
println("Wynik dla zmodyfikowanego najmniejszy-najwiekszy i Float32: ", fromTheSmallestToTheBiggest(modified_x32, y32, Float32, 5))